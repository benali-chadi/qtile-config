...
groups = [Group(i, label=g, layout="monadtall", spawn=s)
          for i, g, s in zip("123456", group_icons, groups_spawn)]
        ...
        ScratchPad(
            ...
            [
                ...
                DropDown(
                    ...
                    'qutebrowser --basedir ' +
                    os.environ['HOME'] +
                    '/.qute_scratchpad/ --config-py /home/chadi/.config/qutebrowser/config.py',
                    x=0.15,
                    y=0.2,
                    height=0.6,
                    width=0.7,
